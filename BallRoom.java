...
public class BallRoom extends JApplet{
	...
	public static final int WIDTH = 400;  //sets the width of the canvas
	public static final int HEIGHT = 400; // sets the height of the canvas
	private PaintSurface canvas;
	
	public void init(){                   // the init method creates an instance of the canvas and call the paint object method every 20 milliseconds
...
class AnimationThread implements Runnable{ // This method creates a thread that calls the repaint method every 20milliseconds
	JApplet c;
...
class PaintSurface extends JComponent{   // This class describes the characteristics of the animated ball
	...
	public void paint(Graphics g){
		...
		if(ball.intersects(paddle_x, paddle_y, 60, 8) && ball.y_speed > 0){
			...
			ball.x_speed = (int)(ball.x_speed * 10);
			if(english != 1.0f)
				colorIndex++;
